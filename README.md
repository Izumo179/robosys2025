...
開発者の環境は「Ubuntu 22.04/Python 3.10」です．
git hubのテストでは「Python3.7/3.8/3.9/3.10」の環境で正常に動作することが確認できています．
...
- このパッケージのコードの一部の書き方や構成は，下記のスライド（CC-BY-SA 4.0 by Ryuichi Ueda）のものを，本人の許可を得てを参考にし自身の著作としたものです．
